/* A  book  shop  uses  a  personal  computer  to  maintain  the inventory of  books that  are being sold  at the  shop.  The  list includes details such as author,
 title, price, publisher, stock position.  etc.  Whenever  a  customer  want  a  book,  the  shop keeper  inputs  the  title  and  author  of  the  book  and  system 
replies whether  it is in the list or not. If it is not in the list, an appropriate message is displayed.  If it is in the list, then the system displays the book details and asks for number of 
copies. If the requested copies are available, the total cost of the  books  are  displayed,  otherwise  the  message  “required copies not in the stock” is displayed. */
#include<stdio.h>
#include<string.h>
#include<stdlib.h>
