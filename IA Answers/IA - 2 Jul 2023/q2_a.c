/* Define a structure called student_info that will contain USN, Name of the student, marks in 3 IAs and CTA as its members. Using student_info, write a C program 
