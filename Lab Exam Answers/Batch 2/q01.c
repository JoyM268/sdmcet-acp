/* Write a function maxmin () which returns maximum and minimum element of a given list of ‘n’ elements. Use this function to compute  highest and lowest marks 
of ‘n’ students in a particular course. Process the array elements using pointers. */ 
 #include <stdio.h> 
 #define SIZE 100 
